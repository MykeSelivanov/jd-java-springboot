...
import com.training.entity.DefaultExceptionMessageDto;
...
public class ExceptionMessageHandler {
    ...
    private Optional<DefaultExceptionMessageDto> getMessageFromAnnotation(Method method) {
        com.training.annotation.DefaultExceptionMessage defaultExceptionMessage = method.getAnnotation(com.training.annotation.DefaultExceptionMessage.class);
